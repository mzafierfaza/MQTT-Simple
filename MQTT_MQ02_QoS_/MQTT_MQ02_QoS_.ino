...
void loop() {
  nilaiAsap = analogRead(MQPIN);
  uint16_t packetIdPub = mqttClient.publish(MQTT_PUB_MQ02, 2, true, String(nilaiAsap).c_str()); //

  Serial.printf("Publishing on topic %s at QoS 2, packetId %i: ", MQTT_PUB_MQ02, packetIdPub);
